...
from factory.radam import PlainRAdam
...
def radam(parameters, lr, betas=(0.9, 0.999), eps=1e-8, weight_decay=0, **_):
    return PlainRAdam(parameters, lr=lr, betas=betas, eps=eps, weight_decay=weight_decay)
